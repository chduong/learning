...
image_dir = os.path.join(cwd, 'image_timeseries') #creates path for cwd\image_timeseries

# Show how the paths work

# need to do this list comprehension because of ds_Store
files = [f for f in os.listdir(image_dir) if f.endswith('.jpg')] # list comprehension process
...
plt.subplot(211) # 2 subplots, 1 column, first plot (2, 1, 1)
